...
import Myhealth.myhealth.services.MedecinDetailsServiceImpl;
import Myhealth.myhealth.services.PatientDetailsServiceImpl;
...
public class AuthTokenFilterMedecin extends OncePerRequestFilter {
  ...
  private static final Logger logger = LoggerFactory.getLogger(AuthTokenFilterMedecin.class);
    ...
    try {
      ...
      if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
        ...
        recuperer les details de l'utilisateur à partir de son token à savoir:
          ...
          boolean isEnabled();
         */
        UserDetails userDetails = medecinDetailsService.loadUserByUsername(username);
