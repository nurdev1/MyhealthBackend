...
public class AuthTokenFilterPatient extends OncePerRequestFilter {
  ...
  private static final Logger logger = LoggerFactory.getLogger(AuthTokenFilterPatient.class);
    ...
    try {
      ...
      if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
        ...
        recuperer les details de l'utilisateur à partir de son token à savoir:
          ...
          boolean isEnabled();
         */
        UserDetails userDetails = patientDetailsService.loadUserByUsername(username);
